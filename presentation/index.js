      ...
      <Deck transition={['zoom', 'slide']} transitionDuration={500} theme={theme}>
        <Slide transition={['slide']} bgColor="primary">
          <Heading size={1} caps lineHeight={1} textColor="headingColor">
            Serverless<br/>Meetup<br/>2018-03-12
          </Heading>
        </Slide>
        ...
        <Slide transition={['slide']} bgColor="primary">
          ...
          <List>
            <ListItem className="margin-bottom-20"><span style={{color: "white"}}>Pál Dávid Gergely</span> Moving a Node.js application from Virtual Machines to Containers and then to Serverless</ListItem>
